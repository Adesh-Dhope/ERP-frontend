...
const InwardOutward = () => {
  ...
  xAxis: {
    type: 'category',
    data: ['Inward', 'Outword', 'Last 7', 'Hazare', 'Trans',"Alloc","Duol"],
    axisLabel: {
      show: true,
...
<div className="w-full h-[26rem] p-4 flex flex-col  border border-gray-200 rounded-md">
  <h1 className="text-xl font-bold mb-4 text-start">{"Inward vs Outward (Last 7 days)"} </h1>
